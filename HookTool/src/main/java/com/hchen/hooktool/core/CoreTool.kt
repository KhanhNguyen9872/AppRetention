...
open class CoreTool : XposedLog() {
    companion object {
        ...
        fun existsClass(
            ...
            return className.hasClass(classLoader)
        }
        ...
        fun existsField(
            ...
            return clazz.hasField(fieldName)
        }
        ...
        fun existsField(
            ...
            return className.findClassIfExists(classLoader)?.hasField(fieldName) ?: false
        }
        ...
        fun existsMethod(
            ...
            return clazz.hasMethod(methodName, *parameterTypes)
        }
        ...
        fun existsMethod(
            ...
            return className.hasMethod(methodName, *parameterTypes)
        }
        ...
        fun existsMethod(
            ...
            return className.hasMethod(classLoader, methodName, *parameterTypes)
        }

        @JvmStatic
        fun existsConstructor(
            clazz: Class<*>,
            vararg parameterTypes: Any
        ): Boolean {
            return clazz.hasConstructor(*parameterTypes)
        }
        ...
        fun existsConstructor(
            ...
            return className.hasConstructor(*parameterTypes)
        }
        ...
        fun existsConstructor(
            ...
            return className.hasConstructor(classLoader, *parameterTypes)
        }
        ...
        fun existsAnyMethod(
            ...
            return try {
                clazz.findAllMethod(methodName).isNotEmpty()
            } catch (_: Throwable) {
                false
            }
        }
        ...
        fun existsAnyMethod(
            ...
            return try {
                className.findClassIfExists(classLoader)?.let { existsAnyMethod(it, methodName) } ?: false
            } catch (_: Throwable) {
                false
            }
        }
