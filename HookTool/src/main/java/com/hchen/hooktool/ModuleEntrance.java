...
public abstract class ModuleEntrance extends XposedModule {
     ...
     */
    public void handleHotReloaded(@NonNull Object param, @NonNull ClassLoader classLoader) {
    }
    ...
    public final boolean onHotReloading(@NonNull Object param) {
        return false;
    }

    public final void onHotReloaded(@NonNull Object param) {
    }
